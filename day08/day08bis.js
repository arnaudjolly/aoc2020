...
function solve1(code) {
    return new bc.BootCode(code).run();
}
...
const boot = bc.fromFile(process.argv.slice(2)[0]);
console.log(JSON.stringify(boot.instructions));